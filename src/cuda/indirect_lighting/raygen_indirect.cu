...
extern "C" __global__ void __raygen__indirect()
{
    ...
    // Payload: RGB color + t_hit
    unsigned int p0 = __float_as_uint(0.0f);  // R
    unsigned int p1 = __float_as_uint(0.0f);  // G
    unsigned int p2 = __float_as_uint(0.0f);  // B
    unsigned int p3 = __float_as_uint(1e16f); // t_hit
